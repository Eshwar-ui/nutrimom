...
/** The admin chrome. Lives here rather than in `app/admin/layout.tsx` because
 *  it's a client component, and that layout has to stay a server component to
 *  export `metadata` (the admin area must be noindex). */
